...
distribution = pkg_resources.require('bob.pad.base')[0]
...
htmlhelp_basename = 'bob_spoof_base_doc'
...
latex_documents = [
  ('index', 'bob_spoof_base.tex', u'Bob',
...
man_pages = [
    ('index', 'bob.pad.base', u'Base tools to run presentation attack detection experiments', [u'Idiap Research Institute'], 1)
]
...
intersphinx_mapping = link_documentation(['python', 'numpy', 'bob.pad.speech', 'gridtk', 'bob.db.avspoof'])
